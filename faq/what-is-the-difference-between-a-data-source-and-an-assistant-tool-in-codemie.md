# What is the difference between a Data Source and an Assistant Tool in CodeMie?
...
- Usage: Tools are integrated through the User integrations menu, where you can specify credentials and set up the connection. These tools enable the assistant to perform actions within these systems or fetch data as needed.
