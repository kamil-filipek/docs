...
This section covers how to create, manage, and use Skills in AI/Run CodeMie.

---

## Getting Started

Learn the basics of creating and managing skills:

- [Skills Overview](./skills-overview) - Introduction to skills and their capabilities
- [Create Skill](./create-skill) - Build a skill from scratch or import from file
- [Manage Skills](./manage-skills) - Edit, export, and delete skills

## Using Skills

Attach and use skills with assistants:
