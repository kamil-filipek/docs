...
If you already have a provisioned AKS cluster with all required Azure services (networking, storage, databases, etc.), you can skip this section and proceed directly to [Components Deployment](../components-deployment/index.md).
:::
