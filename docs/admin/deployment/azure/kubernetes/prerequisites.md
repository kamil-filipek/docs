...
sidebar_position: 2
pagination_prev: admin/deployment/azure/kubernetes/overview
pagination_next: admin/deployment/azure/kubernetes/architecture
---
...
- **Contributor Role** for the deployment user with the following permissions:
  ...
  - Ability to create and manage Azure resources (AKS, networking, storage, etc.)
    ...
    For a detailed list of all Azure resources that will be provisioned, refer to the [Infrastructure Deployment](./infrastructure-deployment/index.md) section or review the Terraform modules in the deployment repository.
    :::
