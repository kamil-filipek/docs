...
This page outlines the requirements and prerequisites necessary for deploying AI/Run CodeMie on Google Cloud Platform (GCP).
...
- **Project Owner or Editor Role** for the deployment user with the following permissions:
  ...
  - Access to create and manage GCP resources (GKE, VPC, Cloud SQL, etc.)
    ...
    For a detailed list of all GCP resources that will be provisioned, refer to the [Infrastructure Deployment](./infrastructure-deployment/index.md) section or review the Terraform modules in the deployment repository.
    :::
