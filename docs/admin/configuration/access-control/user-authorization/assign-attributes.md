...
![Attributes Tab](@site/docs/admin/configuration/images/user-configuration/image-2025-9-15_1-38-42.png)

### 2. Add Attributes

Click the **Add attributes** button to create a new attribute.

![Add Attributes Button](@site/docs/admin/configuration/images/user-configuration/image-2025-9-15_1-38-51.png)
...
![Standard User Attribute](@site/docs/admin/configuration/images/user-configuration/image-2025-9-15_1-38-56.png)
...
![Project Admin Attributes](@site/docs/admin/configuration/images/user-configuration/image-2025-9-15_1-42-30.png)
