...
![Integrations Tab](@site/docs/admin/configuration/images/user-configuration/image-2025-9-17_10-15-44.png)

#### 11. Click the `Create` button in the top right corner and select `Create Project Integration`.

![Create Integration](@site/docs/admin/configuration/images/user-configuration/image-2025-9-17_10-16-37.png)
...
![Integration Configuration](@site/docs/admin/configuration/images/user-configuration/image-2025-9-17_10-18-27.png)
...
![Start Chat](@site/docs/admin/configuration/images/user-configuration/image-2025-9-17_10-44-43.png)

#### 2. Create Users with a Prompt

First, verify the connection with a simple prompt like `Show number of users in the realm`.

![Verify Connection](@site/docs/admin/configuration/images/user-configuration/image-2025-9-17_13-58-17.png)
