...
## Phase 2.6: Cross-Reference Analysis

After identifying the most appropriate section, scan for **hub pages** that link to or list
related content and will need updating when the new documentation is added.
...
Do **not** edit hub pages yet — that happens in Phase 6 after the documentation is written.
...
Choose the icon that best matches the section's primary purpose. If nothing fits exactly,
use `tool.svg` as a fallback.
